  ...
  return (
    <div className="space-y-2">
      {label && (
        <label
          htmlFor={triggerId}
          className="block text-sm font-medium text-gray-700 transition-all duration-200 ease-in-out"
        >
          {label}
        </label>
      )}
      <SelectPrimitive.Trigger
        ...
        className={cn(
          ...
          'focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 focus:shadow-lg',
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-100 min-w-32 overflow-hidden rounded-lg border border-gray-200 bg-white text-gray-900 shadow-lg',
        'max-h-96',
