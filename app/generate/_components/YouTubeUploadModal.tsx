        ...
        <div className="px-8 py-8 max-h-[calc(90vh-220px)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent hover:scrollbar-thumb-gray-400 space-y-7">
          ...
          {resolvedVideoFormatKind === 'long' ? (
            <WallpaperGeneratorSection
              ...
              theme={YOUTUBE_WALLPAPER_THEME}
              copy={{
                title: 'Wallpaper Generator',
                description: 'For regular (16:9) videos, generate a high-quality wallpaper image based on your script.',
                promptNote: 'Uses your full script as the prompt to create a wallpaper image.',
              }}
            />
          ) : null}
