        ...
        <div className="space-y-8 pb-4">
          {sentences.length > 0 ? (
            <div className="space-y-6">
              {/* Header Section */}
              <div className="bg-gradient-to-br from-indigo-50 via-purple-50/40 to-white rounded-2xl p-6 border border-indigo-100/60 shadow-sm">
                <div className="flex items-center justify-between flex-wrap gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Button
                      ...
                      className="gap-2 h-10 px-5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white shadow-md hover:shadow-lg transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      {isGeneratingAllImages ? (
                        <>
                      ...
                      <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="lg:w-64 space-y-3">
                          ...
                          <div className="flex items-center justify-between gap-2">
                            <div className="rounded-xl bg-linear-to-r from-purple-600/25 via-indigo-600/25 to-blue-600/25 p-px shadow-sm">
                              <div className="flex items-center gap-1 rounded-xl bg-white/90 p-1">
                                <Button
                                  type="button"
                                  size="sm"
                                  variant="ghost"
                                  ...
                                  className={
                                    mediaMode === 'single'
                                      ? 'h-7 px-2 text-[10px] font-semibold rounded-lg bg-linear-to-r from-purple-600 to-indigo-600 text-white shadow-sm hover:from-purple-700 hover:to-indigo-700 hover:text-white'
                                      : 'h-7 px-2 text-[10px] font-semibold rounded-lg text-gray-700 hover:bg-linear-to-r hover:from-purple-50 hover:to-indigo-50'
                                  }
                                >
                                  Image
                                </Button>
                          ...
                          {mediaMode === 'single' && !(item.image || item.imageUrl || item.video || item.videoUrl) && (
                            <div
                              className="bg-linear-to-br from-blue-50 via-indigo-50/60 to-purple-50/40 border-2 border-dashed border-indigo-200/70 rounded-xl p-4 text-center space-y-3 hover:border-indigo-300 transition-all duration-200 cursor-pointer shadow-sm"
                              onClick={() => document.getElementById(`sentence-image-${item.id}`)?.click()}
                            >
                              <div className="flex flex-col items-center gap-2 pointer-events-none">
                                <div className="p-2 bg-white/90 rounded-lg shadow-sm border border-indigo-100">
                              ...
                              <div className="relative pointer-events-none">
                                <div className="absolute inset-0 flex items-center">
                                  <div className="w-full border-t border-indigo-200/70"></div>
                                </div>
                                <div className="relative flex justify-center text-xs">
                                  <span className="bg-blue-50 px-2 text-indigo-500 font-medium">or</span>
                                </div>
                              </div>
                              <div className="grid grid-cols-2 gap-2 pointer-events-auto">
                                ...
                                <Button
                                  ...
                                  className="gap-1.5 border-indigo-200 text-indigo-700 hover:bg-linear-to-r hover:from-blue-50 hover:to-indigo-50 hover:border-indigo-300"
                                >
                            ...
                            <div className="space-y-2">
                              <div className="grid grid-cols-2 gap-2">
                                ...
                                <div className="space-y-1">
                                  <p className="text-[10px] font-semibold bg-linear-to-r from-purple-700 to-indigo-700 bg-clip-text text-transparent">Start</p>
                                  {startPreviewUrl ? (
                                    <div className="relative rounded-xl overflow-hidden bg-linear-to-r from-purple-600/30 to-indigo-600/30 p-px shadow-sm">
                                      <div className="relative rounded-[11px] overflow-hidden bg-gray-100">
                                        <img
                                          src={startPreviewUrl}
                                          alt="Start frame"
                                        ...
                                        <button
                                          ...
                                          className="absolute top-1 right-1 p-1 bg-linear-to-r from-red-500 to-rose-600 text-white rounded-full hover:from-red-600 hover:to-rose-700 shadow-lg transition-all"
                                    ...
                                    <div
                                      className="bg-linear-to-br from-blue-50 via-indigo-50/60 to-purple-50/40 border-2 border-dashed border-indigo-200/70 rounded-xl p-3 text-center hover:border-indigo-300 transition-all duration-200 cursor-pointer shadow-sm"
                                    ...
                                    >
                                      ...
                                      <div className="flex flex-col items-center gap-1 pointer-events-none">
                                        <div className="p-1.5 bg-white/90 rounded-lg shadow-sm border border-indigo-100">
                                      ...
                                      {onGenerateSentenceFrameImage ? (
                                        <div className="mt-2 pointer-events-auto">
                                          <Button
                                            ...
                                            className="h-7 w-full gap-1.5 bg-linear-to-r from-emerald-500 to-teal-600 text-white shadow-sm hover:shadow-md hover:opacity-90 transition-all duration-200"
                                          >
                                ...
                                {/* End Frame */}
                                <div className="space-y-1">
                                  <p className="text-[10px] font-semibold bg-linear-to-r from-purple-700 to-indigo-700 bg-clip-text text-transparent">End</p>
                                  {endPreviewUrl ? (
                                    <div className="relative rounded-xl overflow-hidden bg-linear-to-r from-purple-600/30 to-indigo-600/30 p-px shadow-sm">
                                      <div className="relative rounded-[11px] overflow-hidden bg-gray-100">
                                        <img
                              ...
                              {!canGenerateVideo ? (
                                <div className="rounded-xl border border-indigo-200/70 bg-linear-to-r from-blue-50 to-indigo-50 px-3 py-2 shadow-sm">
                                  <p className="text-[10px] text-indigo-700">
                                    Upload both Start and End frames to enable{' '}
                                    <span className="font-semibold">Generate Video</span>.
                                  </p>
                                </div>
                              ) : null}

                              {/* Generate Video Button (always visible in Video tab) */}
                              <Button
                                type="button"
                                size="sm"
                                onClick={async () => {
                                ...
                                className="h-8 w-full gap-2 text-xs font-semibold bg-linear-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white shadow-sm hover:shadow transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                              >
                                {!isGeneratingVideoBySentenceId[item.id] && <VideoIcon className="h-4 w-4" />}
                              ...
                              {(item.video || item.videoUrl) ? (
                                <div className="space-y-2">
                                  <div className="relative rounded-lg overflow-hidden border-2 border-gray-200 bg-gray-100 shadow-md">
                                    <video
                                      src={
                                        item.video
                              ...
                              <div className="flex flex-col gap-2">
                                <div className="flex gap-2">
                                  <Button
                                    ...
                                    className={`${!hasAnyImage && hasAnyVideo ? 'w-full' : 'flex-1'} gap-1.5 text-xs border-blue-200 text-blue-700 hover:bg-blue-50 hover:border-blue-300`}
                                  >
                                    <Library className="h-3 w-3" />
                                    Change
                                  </Button>
